...
mycol2 = mydb["complaint_initial"]
issue = list(mycol.find().sort([('_id', -1)]).limit(1))[0]['complaint']
import nltk
...
print(cat_dict[tag])
# mycol2.insert_one({'category':cat_dict[tag],'category_id':int(tag),'complaint':issue})
